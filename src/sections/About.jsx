                ...
                <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                    <div className="lg:pl-20">
                        <div className="max-w-xs px-2.5 lg:max-w-none">
                            ...
                            <img width="800" height="800" className="h-auto bg-[#27272AE6] max-w-sm transition-all -row-span-3 duration-300 rounded-lg blur-sm hover:blur-none cursor-pointer" src={logo} />
                        </div>
                    </div>
